...
router.post('/start/:sessionId', requireAdmin, async (req, res) => {
    ...
    try {
        const session = await getById('gym-live-sessions', req.params.sessionId);
        if (!session) {
...
//# sourceMappingURL=gymLive.js.map